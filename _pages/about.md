...
6. Post-harvesting yield estimation in the almond field;
7. Instrumented cart system for data collection in the strawberry field;

Ongoing Research Projects:
=========
1. Vision based orchard SLAM and navigation;
4. Human robot interaction in the agricultural application;
6. Trajectory planning of E-tractor in cluttered headland space;
7. Learning-based Strawberry harvesting robot;
8. Net cage fishing supervision with Underwater Robot;


## <i class="fa fa-fw fa-rss "></i> Recent News ##
<ul style="width: auto; height: 300px; overflow: auto">
  
  <li> <b>[April, 2024]</b>. A journal paper published on JFR was accepted. </li>

  <li> <b>[July, 2023]</b>. I joined HIC-ZJU as a [researcher (PI)](https://hic.zju.edu.cn/2023/0904/c72951a2797324/page.htm). </li>
